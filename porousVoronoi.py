...
def main():
    ...
    data.stlread(
        ...
        (-2.5, -2.5, 0.0),
        (2.5, 2.5, 5.0),
        "/home/yijun/GitHub_Projects/TopOpt_in_PETSc_wrapped_in_Python/stl/porousVoronoi.stl",
    )
    ...
    # data.bc(0, 2, [0, 1, 2], [0.0, 0.0, 5.0], [2], [-0.00025], 0)
    # data.bc(0, 2, [0, 1, 2], [5.0, 0.0, 5.0], [2], [-0.00025], 0)
    # data.bc(0, 2, [0, 1, 2], [5.0, 5.0, 5.0], [2], [-0.00025], 0)
    # data.bc(0, 2, [0, 1, 2], [0.0, 5.0, 5.0], [2], [-0.00025], 0)
    data.bc(0, 2, [2], [5.0], [2], [-0.00025], 0)
